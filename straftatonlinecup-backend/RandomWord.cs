class RandomWord() {
    ...
    "jerma985", "victory", "corncob", "hebrew", "yellow", "zebra", "adventure", "bridge", "clock",
    ...
    "bamboo", "cloud", "dew", "eagle", "flame", "atakak", "hurricane", "kelp", "therotconsumes", "nectarine", "petunia",
    ...
    "newt", "opaline", "y2k", "sunflower", "tornado", "valkyrie", "wind", "aurora", "bronze", "cavern",
    "dust", "emberglow", "frost", "granite", "infiltration", "ironwood", "karst", "pogchamp", "marigold", "nightshade",
    "obsidian", "prism", "ohio", "shimmer", "twilight", "upland", "verdant", "whimsy", "zeal", "breeze",
    "cherry", "dusk", "eepy", "foxglove", "gale", "petergriffininfortnite", "illusion", "jewel", "keystone", "lotus",
